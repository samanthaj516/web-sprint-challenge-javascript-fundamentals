...
//Nested function can access the variable internal because all functions have access to the scope "above" them
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(/*Your Code Here*/){
      let lowerCaseArray = [];
        zooAnimals.map(obj => {
        lowerCaseArray.push(obj.animal_name.toLowerCase());
        });
...
//   // let lowPopulation = [];
//   // lowPopulation.push(zooAnimals.filter(obj => {
//   //   obj.population < 5 
//   // }));
//   let lowPopulation = [console.log(zooAnimals.filter((item) => item.population < 5))];
//   return lowPopulation;
//   }  
//   console.log(lowPopulationAnimals());

  function lowPopulationAnimals(/*Your Code Here*/){
      let lowPopulation = zooAnimals.filter((item) => item.population < 5);
      return lowPopulation;
    }  
lowPopulationAnimals();
 ...
 function USApop(/*Your Code Here*/){
  const totalPopulation = zooAnimals.reduce((total, item) => {return total + item.population}, 0);
